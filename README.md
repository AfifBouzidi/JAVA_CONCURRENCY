...
Il existe une instance commune ForkJoinPool disponible pour toutes les applications qu'on peut obtenir avec la méthode statique commonPool(): ````ForkJoinPool commonPool = ForkJoinPool.commonPool();````
